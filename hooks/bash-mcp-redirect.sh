...
RULES=(
  ...
  "terraform output|warn|mcp__bash-mcp__tf_outputs (roadmap)"
  "terraform providers|warn|mcp__bash-mcp__tf_providers (roadmap)"
  "terraform validate|warn|mcp__bash-mcp__tf_validate_summary (roadmap)"
